...
if 'MetaData_Output' in locals() and  isinstance(MetaData_Output, pd.DataFrame):
       ...
       base_data_v1=base_data_v1.copy()
       base_data_v1.loc[:,"MetaData_Exception_Flag"]=(base_data_v1["MetaData_Exception_Flag"].fillna("No"))
...
PDF_Edit_Output.to_excel("C:/MSIL/Enterprise Application/Session_ID/codes/New Codes/test1.xlsx")    
...
base_data_v1.to_excel("C:/MSIL/Enterprise Application/Session_ID/codes/New Codes/test2.xlsx")
...
base_data_v1.to_excel("C:/MSIL/Enterprise Application/Session_ID/codes/New Codes/test3.xlsx")
...
if 'Copy_Move_Output' in locals() and  isinstance(Copy_Move_Output, pd.DataFrame):
    ...
    Copy_Move_Output_v1["Output_File_Name"]=Copy_Move_Output_v1["File_Name"].apply(lambda x:x)
