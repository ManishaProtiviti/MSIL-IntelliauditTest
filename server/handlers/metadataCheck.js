...
const name = 'Meta Data Forgery'
const folders = ["Input Files", "Image Files", "Excel Files"]

export async function metadataCheck(requestId, checksJsonColl) {
  // const metadata = {};
  ...
  // const scriptPath = path.join(process.cwd(), "scripts", "dist", checksMappingWithPythonFile.metadataChk);
 ...
 console.log("checkjsoncall",checksJsonColl)
  ...
  return result;  
    ...
    console.log("Error in Meta Data Forgery script", err);
  }
}